...
# start the measure
class AedgSmallToMediumOfficeExteriorWallConstruction < OpenStudio::Measure::ModelMeasure
...
AedgSmallToMediumOfficeExteriorWallConstruction.new.registerWithApplication
