...
class AedgSmallToMediumOfficeExteriorDoorConstruction_Test < Minitest::Test
  def test_AedgSmallToMediumOfficeExteriorDoorConstruction
    # create an instance of the measure
    measure = AedgSmallToMediumOfficeExteriorDoorConstruction.new
