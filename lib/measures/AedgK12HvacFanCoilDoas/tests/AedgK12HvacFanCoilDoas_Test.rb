...
class AedgK12HvacFanCoilDoas_Test < Minitest::Test
  def test_AedgK12HvacFanCoilDoas
    # create an instance of the measure
    measure = AedgK12HvacFanCoilDoas.new
    ...
    model.save("#{output_dir}/test_1.osm", true)
  end

  def test_AedgK12HvacFanCoilDoas_NoPlenum
    # create an instance of the measure
    measure = AedgK12HvacFanCoilDoas.new
    ...
    output_dir = File.expand_path('output', File.dirname(__FILE__))
    FileUtils.mkdir output_dir unless Dir.exist? output_dir
    model.save("#{output_dir}/test_2.osm", true)
  end
end
