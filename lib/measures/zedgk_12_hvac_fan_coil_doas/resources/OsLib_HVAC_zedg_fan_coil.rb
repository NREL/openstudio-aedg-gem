module OsLib_HVAC_zedg_fan_coil

  # do something
  def OsLib_HVAC_zedg_fan_coil.doSomething(input)
  ...
  def OsLib_HVAC_zedg_fan_coil.validateAndAddPlenumZonesToSystem(model, runner, options = {})
  ...
  def OsLib_HVAC_zedg_fan_coil.sortZones(model, runner, options = {})
  ...
  def OsLib_HVAC_zedg_fan_coil.reportConditions(model, runner, condition,extra_string = '')
  ...
  def OsLib_HVAC_zedg_fan_coil.removeEquipment(model, runner)
  ...
  def OsLib_HVAC_zedg_fan_coil.assignHVACSchedules(model, runner, options = {})
  ...
  def OsLib_HVAC_zedg_fan_coil.createHotWaterPlant(model, runner, hot_water_setpoint_schedule, loop_type)
  ...
  def OsLib_HVAC_zedg_fan_coil.createChilledWaterPlant(model, runner, chilled_water_setpoint_schedule, loop_type, chillerType)
  ...
  def OsLib_HVAC_zedg_fan_coil.createCondenserLoop(model, runner, options)
  ...
  def OsLib_HVAC_zedg_fan_coil.createPrimaryAirLoops(model, runner, options)
    primary_airloops = []
  ...
  def OsLib_HVAC_zedg_fan_coil.createSecondaryAirLoops(model, runner, options)
  ...
  def OsLib_HVAC_zedg_fan_coil.createPrimaryZoneEquipment(model, runner, options)
  ...
  def OsLib_HVAC_zedg_fan_coil.addDCV(model, runner, options)
