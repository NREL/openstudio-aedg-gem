...
# start the measure
class AedgK12ElectricEquipment < OpenStudio::Measure::ModelMeasure
  ...
  def run(model, runner, user_arguments)
    ...
    rules << ['LowEnergy', 'PrimarySchool', 'Corridor', 0.0]
    ...
    rules << ['LowEnergy', 'PrimarySchool', 'Lobby', 0.00]
    rules << ['LowEnergy', 'PrimarySchool', 'Mechanical', 0.00]
    rules << ['LowEnergy', 'PrimarySchool', 'Office', 0.3]
